module GroveComponents.Utils.DigitAnimatorHelper exposing (valueFormattedStringToDigits, valueFormattedStringToRandomDigits)

import GroveComponents.DisplayCurrency exposing (DisplayCurrency(..))
import GroveComponents.Utils.GroveHtmlAttributes exposing (class, property)
